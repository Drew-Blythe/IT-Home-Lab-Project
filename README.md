...
**Core Problems Encountered In AD Project**

**VM Setup**  
Fixed Windows Server 2022 virtual machine auto abort on pc by enabling virtualization on CPU via SVM Mode in BIOS  
